...
highlight taskWorkingItem guifg=#f6f3e8 guibg=black gui=bold ctermfg=NONE ctermbg=NONE cterm=NONE
highlight taskDoneItem guifg=#A8FF60 guibg=black gui=bold ctermfg=green ctermbg=black cterm=NONE

highlight taskWorkingIcon guifg=#FF6C60 guibg=black gui=bold ctermfg=red ctermbg=black cterm=NONE
highlight taskDoneIcon guifg=#A8FF60 guibg=black gui=bold ctermfg=green ctermbg=black cterm=NONE
